  ...
  return (
    <div className="rules">
      ...
      <ol>
        ...
        <li>Trading can be done on 50 companies from the NYSE and NASDAQ.</li>
        <li>
          The game will follow actual market timings (07:00 PM to 1:30 AM
        ...
        <li>
          ...
          <ul>
            <li>
              Stock Info: DALALBULL provides stock information for 50 companies
              from NASDAQ AND NYSE and you are allowed to trade with these
        ...
        <ul>
          ...
          <li>
            Market Trading: You trade straight away without keeping any limit at
            the current price. And accordingly brokerage will be deducted for
